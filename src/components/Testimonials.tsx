...
const testimonials = [
  {
    ...
    catName: "Whiskers",
    ownerName: "Emily",
    message: "Whiskers finally eats everything in the bowl! He literally jumps with excitement at mealtime now.",
    image: "https://images.unsplash.com/photo-1533743983669-94fa5c4338ec?q=80&w=92&auto=format&fit=crop",
  },
  {
    id: 2,
    catName: "Luna",
    ownerName: "Michael",
    message: "My picky eater Luna absolutely loves the Salmon Sensation. Her coat looks healthier than ever!",
    image: "https://images.unsplash.com/photo-1618826411640-d6df44dd3f7a?q=80&w=92&auto=format&fit=crop",
  },
  {
    id: 3,
    catName: "Oliver",
    ownerName: "Sarah",
    message: "Oliver has more energy and less digestive issues since switching to these recipes. Thank you!",
    image: "https://images.unsplash.com/photo-1568152950566-c1bf43f4ab28?q=80&w=92&auto=format&fit=crop",
  },
  {
    id: 4,
    catName: "Simba",
    ownerName: "David",
    message: "The subscription box is so convenient and Simba gets excited when he sees the delivery arrive!",
    image: "https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?q=80&w=92&auto=format&fit=crop",
  },
  {
    id: 5,
    catName: "Milo",
    ownerName: "Jessica",
    message: "Milo is 12 years old and the Senior Vitality formula has given him a new lease on life!",
    image: "https://images.unsplash.com/photo-1573865526739-10659fec78a5?q=80&w=92&auto=format&fit=crop",
  }
];
      ...
      <div className="container mx-auto">
        ...
        <div className="relative max-w-4xl mx-auto">
            ...
            {visibleTestimonials.map((testimonial, idx) => (
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-display font-semibold">{testimonial.catName}</h3>
                    <p className="text-sm text-neutral-500">& {testimonial.ownerName}</p>
                  </div>
                </div>
          ...
          <div className="md:hidden">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="font-display font-semibold">{testimonials[activeIndex].catName}</h3>
                  <p className="text-sm text-neutral-500">& {testimonials[activeIndex].ownerName}</p>
                </div>
              </div>
              <p className="text-neutral-600">{testimonials[activeIndex].message}</p>
              <div className="mt-4 flex items-center text-primary-foreground">
                <Heart size={16} className="mr-2 fill-current" />
                <span className="text-sm">Verified Customer</span>
              </div>
          ...
          <div className="hidden md:block">
            <button 
              onClick={() => changeTestimonial(activeIndex > 0 ? activeIndex - 1 : testimonials.length - 1)}
        ...
        <div className="text-center mt-12">
          <h3 className="text-2xl font-display font-semibold mb-4">Over 50,000 happy cats can't be wrong!</h3>
