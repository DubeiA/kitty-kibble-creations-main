...
const slides = [
  {
    image:
      'https://images.unsplash.com/photo-1618160702438-9b02ab6515c9?q=80&w=1200&auto=format&fit=crop',
    title: 'Natural ingredients.',
    subtitle: 'Happy cats.',
    description:
      'Made with love using only natural ingredients. Because your feline friend deserves nothing but the best.',
  },
  {
    image:
      'https://images.unsplash.com/photo-1721322800607-8c38375eef04?q=80&w=1200&auto=format&fit=crop',
    title: 'Limited Time!',
    subtitle: '20% OFF',
    description:
      'Get an exclusive 20% discount on all premium cat food products. Valid until end of month!',
  },
  {
    image:
    ...
    description:
      'Get 15% off and free shipping with our monthly subscription. Plus, a free toy in every third box!',
  },
];
              ...
              <CarouselItem key={index}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="relative">
                    ...
                    <div
                      className="absolute -bottom-3 -right-3 w-16 h-16 bg-kitty-blue rounded-full opacity-60 animate-float"
